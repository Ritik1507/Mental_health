...
from mental_health.entity.artifact_entity import ModelTrainerArtifacts,DataTransformationArtifacts
from mental_health.ml.model import ModelArchitecture
