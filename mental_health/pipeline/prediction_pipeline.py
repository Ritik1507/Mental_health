...
from mental_health.components.data_transforamation import DataTransformation
...
class PredictionPipeline:
    ...
    def get_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            self.gcloud.sync_folder_from_s3(self.bucket_name, self.model_name, self.model_path)
